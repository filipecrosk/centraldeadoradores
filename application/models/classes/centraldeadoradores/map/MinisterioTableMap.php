...
class MinisterioTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'centraldeadoradores.map.MinisterioTableMap';
    ...
    {
        $this->addRelation('Usuario', 'Usuario', RelationMap::ONE_TO_MANY, array('Id' => 'Id_Ministerio', ), null, null, 'Usuarios');
        $this->addRelation('UsuarioMinisterio', 'UsuarioMinisterio', RelationMap::ONE_TO_MANY, array('Id' => 'Id_Ministerio', ), 'CASCADE', 'CASCADE', 'UsuarioMinisterios');
    } // buildRelations()
