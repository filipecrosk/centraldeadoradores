...
abstract class BaseMinisterio extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = MinisterioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MinisterioPeer::doValidate($this, $columns)) !== true) {
    ...
    public function setUsuarios(PropelCollection $usuarios, PropelPDO $con = null)
    {
        ...
        foreach ($this->usuariosScheduledForDeletion as $usuarioRemoved) {
            $usuarioRemoved->setMinisterio(null);
        }
     ...
     * @return PropelObjectCollection|Usuario[] List of Usuario objects
     */
    public function getUsuariosJoinBandaRelatedByIdBanda($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UsuarioQuery::create(null, $criteria);
        $query->joinWith('BandaRelatedByIdBanda', $join_behavior);
    ...
    public function setUsuarioMinisterios(PropelCollection $usuarioMinisterios, PropelPDO $con = null)
    {
        ...
        foreach ($this->usuarioMinisteriosScheduledForDeletion as $usuarioMinisterioRemoved) {
            $usuarioMinisterioRemoved->setMinisterio(null);
        }
    ...
    protected function doAddUsuarioMinisterio($usuarioMinisterio)
    {
        ...
        $usuarioMinisterio->setMinisterio($this);
    }
    ...
    public function removeUsuarioMinisterio($usuarioMinisterio)
    {
        if ($this->getUsuarioMinisterios()->contains($usuarioMinisterio)) {
            ...
            $usuarioMinisterio->setMinisterio(null);
        }
    }
     ...
     * @return PropelObjectCollection|UsuarioMinisterio[] List of UsuarioMinisterio objects
     */
    public function getUsuarioMinisteriosJoinUsuario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UsuarioMinisterioQuery::create(null, $criteria);
