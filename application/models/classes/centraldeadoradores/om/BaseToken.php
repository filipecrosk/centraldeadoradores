...
abstract class BaseToken extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the chave field.
     * @var        string
     */
    protected $chave;

    /**
     * The value for the utilizada field.
    ...
    /**
     * Get the [utilizada] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [chave] column.
     *
     * @param string $v new value
     * @return Token The current object (for fluent API support)
     */
    public function setChave($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->chave !== $v) {
            $this->chave = $v;
            $this->modifiedColumns[] = TokenPeer::CHAVE;
        }
    ...
    /**
     * Set the value of [utilizada] column.
     *
     * @param int $v new value
     * @return Token The current object (for fluent API support)
     */
    public function setUtilizada($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->utilizada !== $v) {
            $this->utilizada = $v;
            $this->modifiedColumns[] = TokenPeer::UTILIZADA;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TokenPeer::DATA;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->chave = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->utilizada = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = TokenPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TokenPeer::CHAVE)) {
            $modifiedColumns[':p' . $index++]  = '`CHAVE`';
        }
        if ($this->isColumnModified(TokenPeer::UTILIZADA)) {
            $modifiedColumns[':p' . $index++]  = '`UTILIZADA`';
        }
        if ($this->isColumnModified(TokenPeer::DATA)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID`':
                        ...
                        break;
                    case '`CHAVE`':
                        $stmt->bindValue($identifier, $this->chave, PDO::PARAM_STR);
                        break;
                    case '`UTILIZADA`':
                        $stmt->bindValue($identifier, $this->utilizada, PDO::PARAM_INT);
                        break;
                    case '`DATA`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getChave(),
            $keys[2] => $this->getUtilizada(),
            $keys[3] => $this->getData(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setChave($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setUtilizada($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TokenPeer::CHAVE)) $criteria->add(TokenPeer::CHAVE, $this->chave);
        if ($this->isColumnModified(TokenPeer::UTILIZADA)) $criteria->add(TokenPeer::UTILIZADA, $this->utilizada);
        if ($this->isColumnModified(TokenPeer::DATA)) $criteria->add(TokenPeer::DATA, $this->data);
    ...
    {
        $copyObj->setChave($this->getChave());
        $copyObj->setUtilizada($this->getUtilizada());
    ...
    public function setAlteracaoInformacaoUsuarios(PropelCollection $alteracaoInformacaoUsuarios, PropelPDO $con = null)
    {
        ...
        foreach ($this->alteracaoInformacaoUsuariosScheduledForDeletion as $alteracaoInformacaoUsuarioRemoved) {
            $alteracaoInformacaoUsuarioRemoved->setToken(null);
        }
    ...
    protected function doAddAlteracaoInformacaoUsuario($alteracaoInformacaoUsuario)
    {
        ...
        $alteracaoInformacaoUsuario->setToken($this);
    }
    ...
    public function removeAlteracaoInformacaoUsuario($alteracaoInformacaoUsuario)
    {
        if ($this->getAlteracaoInformacaoUsuarios()->contains($alteracaoInformacaoUsuario)) {
            ...
            $alteracaoInformacaoUsuario->setToken(null);
        }
    }
     ...
     * Otherwise if this Token is new, it will return
     * an empty collection; or if this Token has previously
     * been saved, it will retrieve related AlteracaoInformacaoUsuarios from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Token.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
