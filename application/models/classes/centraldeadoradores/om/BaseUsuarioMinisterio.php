...
/**
 * Base class that represents a row from the 'usuario_ministerio' table.
 *
 *
 *
 * @package    propel.generator.centraldeadoradores.om
 */
abstract class BaseUsuarioMinisterio extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UsuarioMinisterioPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UsuarioMinisterioPeer
     */
     ...
     * @return UsuarioMinisterio The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UsuarioMinisterioPeer::ID;
        }
    ...
    public function setIdUsuario($v)
    {
        ...
        if ($this->id_usuario !== $v) {
            $this->id_usuario = $v;
            $this->modifiedColumns[] = UsuarioMinisterioPeer::ID_USUARIO;
        }
    ...
    public function setIdMinisterio($v)
    {
        ...
        if ($this->id_ministerio !== $v) {
            ...
            $this->modifiedColumns[] = UsuarioMinisterioPeer::ID_MINISTERIO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_ministerio = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = UsuarioMinisterioPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UsuarioMinisterio object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UsuarioMinisterioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UsuarioMinisterioQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UsuarioMinisterioPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioMinisterioPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(UsuarioMinisterioPeer::ID_USUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`ID_USUARIO`';
        }
        if ($this->isColumnModified(UsuarioMinisterioPeer::ID_MINISTERIO)) {
            $modifiedColumns[':p' . $index++]  = '`ID_MINISTERIO`';
        }

        $sql = sprintf(
            'INSERT INTO `usuario_ministerio` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UsuarioMinisterioPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UsuarioMinisterioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UsuarioMinisterio'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UsuarioMinisterio'][$this->getPrimaryKey()] = true;
        $keys = UsuarioMinisterioPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdUsuario(),
            $keys[2] => $this->getIdMinisterio(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setIdMinisterio($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioMinisterioPeer::ID)) $criteria->add(UsuarioMinisterioPeer::ID, $this->id);
        if ($this->isColumnModified(UsuarioMinisterioPeer::ID_USUARIO)) $criteria->add(UsuarioMinisterioPeer::ID_USUARIO, $this->id_usuario);
        if ($this->isColumnModified(UsuarioMinisterioPeer::ID_MINISTERIO)) $criteria->add(UsuarioMinisterioPeer::ID_MINISTERIO, $this->id_ministerio);
    ...
    {
        $criteria = new Criteria(UsuarioMinisterioPeer::DATABASE_NAME);
        $criteria->add(UsuarioMinisterioPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UsuarioMinisterio (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UsuarioMinisterio Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UsuarioMinisterioPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UsuarioMinisterioPeer();
        }
    ...
    public function getMinisterio(PropelPDO $con = null)
    {
        if ($this->aMinisterio === null && ($this->id_ministerio !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMinisterio->addUsuarioMinisterios($this);
             */
        }
    ...
    public function getUsuario(PropelPDO $con = null)
    {
        if ($this->aUsuario === null && ($this->id_usuario !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addUsuarioMinisterios($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UsuarioMinisterioPeer::DEFAULT_STRING_FORMAT);
    }
