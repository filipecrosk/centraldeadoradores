...
abstract class BaseTokenPeer
{
    ...
    /** the column name for the CHAVE field */
    const CHAVE = 'token.CHAVE';

    /** the column name for the UTILIZADA field */
    const UTILIZADA = 'token.UTILIZADA';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Chave', 'Utilizada', 'Data', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'chave', 'utilizada', 'data', ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID, TokenPeer::CHAVE, TokenPeer::UTILIZADA, TokenPeer::DATA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CHAVE', 'UTILIZADA', 'DATA', ),
        BasePeer::TYPE_FIELDNAME => array ('Id', 'chave', 'utilizada', 'data', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Chave' => 1, 'Utilizada' => 2, 'Data' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'chave' => 1, 'utilizada' => 2, 'data' => 3, ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID => 0, TokenPeer::CHAVE => 1, TokenPeer::UTILIZADA => 2, TokenPeer::DATA => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CHAVE' => 1, 'UTILIZADA' => 2, 'DATA' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('Id' => 0, 'chave' => 1, 'utilizada' => 2, 'data' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TokenPeer::CHAVE);
            $criteria->addSelectColumn(TokenPeer::UTILIZADA);
            $criteria->addSelectColumn(TokenPeer::DATA);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.CHAVE');
            $criteria->addSelectColumn($alias . '.UTILIZADA');
