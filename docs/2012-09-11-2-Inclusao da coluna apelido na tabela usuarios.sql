...
ALTER TABLE `adoradores`.`usuario` ADD COLUMN `Apelido` VARCHAR(50) NULL DEFAULT NULL  AFTER `Nome` , CHANGE COLUMN `Id_Ministerio` `Id_Ministerio` INT(11) NULL DEFAULT NULL  , 
